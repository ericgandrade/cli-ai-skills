 ...
 */
async function install(cacheDir, skills = null, quiet = false, targetDirOverride = null, label = 'OpenCode') {
  const targetDir = targetDirOverride || getUserSkillsPath('opencode');
