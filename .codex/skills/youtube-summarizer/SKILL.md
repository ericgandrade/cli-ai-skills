...
**User Input:**
```
codex> summarize this video: https://www.youtube.com/watch?v=dQw4w9WgXcQ
```
...
**User Input:**
```
codex> summarize this youtube video https://youtu.be/abc123
```
...
**User Input:**
```
codex> extract youtube transcript https://youtube.com/watch?v=xyz789
```
...
**User Input:**
```
codex> summarize youtube video www.youtube.com/some-video
```
...
**User Input:**
```
codex> summarize this youtube video: https://www.youtube.com/watch?v=exemplo123
```
...
**User Input:**
```
codex> extract transcript from https://youtube.com/watch?v=tech456
```
