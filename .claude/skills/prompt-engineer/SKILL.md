...
**User Input:**
```
claude> crie prompt para: preciso criar um sistema de recomendação de produtos considerando histórico de compras, preferências do usuário e tendências de mercado
```
...
**User Input:**
```
claude> otimize prompt: meu código Python não está funcionando, precisa debugar
```
...
**User Input:**
```
claude> crie prompt para: escrever email profissional para executivos sobre mudança de estratégia
```
